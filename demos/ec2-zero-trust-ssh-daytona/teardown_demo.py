...
stops+deletes both Cloud tunnels (ec2demo-web / ec2demo-dashboard). Reads
.demo-state.json (written by setup_demo.py) for the ids to act on.
...
def main() -> None:
    ...
    for key, description in (
        ("web_tunnel_id", "stopping+deleting the site Cloud tunnel"),
